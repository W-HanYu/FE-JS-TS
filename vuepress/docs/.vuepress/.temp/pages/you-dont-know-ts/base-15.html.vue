<template><div><h2 id="十五、编译上下文" tabindex="-1"><a class="header-anchor" href="#十五、编译上下文" aria-hidden="true">#</a> 十五、编译上下文</h2>
<h3 id="_15-1-tsconfig-json-的作用" tabindex="-1"><a class="header-anchor" href="#_15-1-tsconfig-json-的作用" aria-hidden="true">#</a> 15.1 tsconfig.json 的作用</h3>
<ul>
<li>用于标识 TypeScript 项目的根路径；</li>
<li>用于配置 TypeScript 编译器；</li>
<li>用于指定编译的文件。</li>
</ul>
<h3 id="_15-2-tsconfig-json-重要字段" tabindex="-1"><a class="header-anchor" href="#_15-2-tsconfig-json-重要字段" aria-hidden="true">#</a> 15.2 tsconfig.json 重要字段</h3>
<ul>
...
<h3 id="_15-3-compileroptions-选项" tabindex="-1"><a class="header-anchor" href="#_15-3-compileroptions-选项" aria-hidden="true">#</a> 15.3 compilerOptions 选项</h3>
<p>compilerOptions 支持很多选项，常见的有 baseUrl、 target、baseUrl、 moduleResolution 和 lib 等。</p>
