<template><div><h1 id="键入网址到网页显示-期间发生了什么" tabindex="-1"><a class="header-anchor" href="#键入网址到网页显示-期间发生了什么" aria-hidden="true">#</a> 键入网址到网页显示，期间发生了什么？</h1>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/2.jpg" alt="简单的网络模型"></p>
<h2 id="孤单小弟-——-http" tabindex="-1"><a class="header-anchor" href="#孤单小弟-——-http" aria-hidden="true">#</a> 孤单小弟 —— HTTP</h2>
<blockquote>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/3.jpg" alt="URL 解析"></p>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/4.jpg" alt="HTTP 的消息格式"></p>
<blockquote>
<p>一个孤单 HTTP 数据包表示：“我这么一个小小的数据包，没亲没友，直接发到浩瀚的网络，谁会知道我呢？谁能载我一程呢？谁能保护我呢？我的目的地在哪呢？”充满各种疑问的它，没有停滞不前，依然踏上了征途！</p>
</blockquote>
<hr>
<h2 id="真实地址查询-——-dns" tabindex="-1"><a class="header-anchor" href="#真实地址查询-——-dns" aria-hidden="true">#</a> 真实地址查询 —— DNS</h2>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/5.jpg" alt="DNS 树状结构"></p>
...
<li>根 DNS 收到来自本地 DNS 的请求后，发现后置是 .com，说：“www.server.com 这个域名归 .com 区域管理”，我把 .com 顶级域名服务器的地址给你，你去问问它吧。”</li>
...
<li>本地 DNS 于是转向问权威 DNS 服务器：“老三，www.server.com 对应的 IP 是啥呀？” server.com 的权威 DNS 服务器，它是域名解析结果的原出处。为啥叫权威呢？就是我的域名我做主。</li>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/6.jpg" alt="域名解析的工作流程"></p>
...
<hr>
<h2 id="指南好帮手-——-协议栈" tabindex="-1"><a class="header-anchor" href="#指南好帮手-——-协议栈" aria-hidden="true">#</a> 指南好帮手 —— 协议栈</h2>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/7.jpg" alt=""></p>
...
<hr>
<h2 id="可靠传输-——-tcp" tabindex="-1"><a class="header-anchor" href="#可靠传输-——-tcp" aria-hidden="true">#</a> 可靠传输 —— TCP</h2>
<p>HTTP 是基于 TCP 协议传输的，所以在这我们先了解下 TCP 协议。</p>
<blockquote>
<p>TCP 包头格式</p>
</blockquote>
<p>我们先看看 TCP 报文头部的格式：</p>
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/8.jpg" alt="TCP 包头格式"></p>
...
<ul>
<li>
<p>一开始，客户端和服务端都处于 <code v-pre>CLOSED</code> 状态。先是服务端主动监听某个端口，处于 <code v-pre>LISTEN</code> 状态。</p>
</li>
<li>
<p>然后客户端主动发起连接 <code v-pre>SYN</code>，之后处于 <code v-pre>SYN-SENT</code> 状态。</p>
</li>
<li>
<p>服务端收到发起的连接，返回 <code v-pre>SYN</code>，并且 <code v-pre>ACK</code> 客户端的 <code v-pre>SYN</code>，之后处于 <code v-pre>SYN-RCVD</code> 状态。</p>
</li>
<li>
<p>客户端收到服务端发送的 <code v-pre>SYN</code> 和 <code v-pre>ACK</code> 之后，发送对 <code v-pre>SYN</code> 确认的 <code v-pre>ACK</code>，之后处于 <code v-pre>ESTABLISHED</code> 状态，因为它一发一收成功了。</p>
</li>
<li>
<p>服务端收到 <code v-pre>ACK</code> 的 <code v-pre>ACK</code> 之后，处于 <code v-pre>ESTABLISHED</code> 状态，因为它也一发一收了。</p>
</li>
</ul>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/10.jpg" alt="TCP 连接状态查看"></p>
<blockquote>
<p>TCP 分割数据</p>
</blockquote>
<p>如果 HTTP 请求消息比较长，超过了 <code v-pre>MSS</code> 的长度，这时 TCP 就需要把 HTTP 的数据拆解成一块块的数据发送，而不是一次性发送所有数据。</p>
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/11.jpg" alt="MTU 与 MSS"></p>
<ul>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/12.jpg" alt="数据包分割"></p>
<blockquote>
<p>TCP 报文生成</p>
</blockquote>
...
<p>至此，网络包的报文如下图。</p>
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/13.jpg" alt="TCP 层报文"></p>
<blockquote>
<p>此时，遇上了 TCP 的  数据包激动表示：“太好了，碰到了可靠传输的 TCP 传输，它给我加上 TCP 头部，我不再孤单了，安全感十足啊！有大佬可以保护我的可靠送达！但我应该往哪走呢？”</p>
</blockquote>
<hr>
<h2 id="远程定位-——-ip" tabindex="-1"><a class="header-anchor" href="#远程定位-——-ip" aria-hidden="true">#</a> 远程定位 —— IP</h2>
<p>TCP 模块在执行连接、收发、断开等各阶段操作时，都需要委托 IP 模块将数据封装成<strong>网络包</strong>发送给通信对象。</p>
<blockquote>
<p>IP 包头格式</p>
</blockquote>
<p>我们先看看 IP 报文头部的格式：</p>
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/14.jpg" alt="IP 包头格式"></p>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/15.jpg" alt="路由表"></p>
<p>举个例子，根据上面的路由表，我们假设 Web 服务器的目标地址是 <code v-pre>192.168.10.200</code>。</p>
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/16.jpg" alt="路由规则判断"></p>
<ol>
...
<p>至此，网络包的报文如下图。</p>
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/17.jpg" alt="IP 层报文"></p>
<blockquote>
<p>此时，加上了 IP 头部的数据包表示 ：“有 IP 大佬给我指路了，感谢 IP 层给我加上了 IP 包头，让我有了远程定位的能力，不会害怕在浩瀚的互联网迷茫了！可是目的地好远啊，我下一站应该去哪呢？”</p>
</blockquote>
<hr>
<h2 id="两点传输-——-mac" tabindex="-1"><a class="header-anchor" href="#两点传输-——-mac" aria-hidden="true">#</a> 两点传输 —— MAC</h2>
<p>生成了 IP 头部之后，接下来网络包还需要在 IP 头部的前面加上 <strong>MAC 头部</strong>。</p>
<blockquote>
<p>MAC 包头格式</p>
</blockquote>
<p>MAC 头部是以太网使用的头部，它包含了接收方和发送方的 MAC 地址等信息。</p>
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/18.jpg" alt="MAC 包头格式"></p>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/19.jpg" alt="ARP 广播"></p>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/20.jpg" alt="ARP 缓存内容"></p>
<blockquote>
<p>MAC 报文生成</p>
</blockquote>
<p>至此，网络包的报文如下图。</p>
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/21.jpg" alt="MAC 层报文"></p>
<blockquote>
<p>此时，加上了 MAC 头部的数据包万分感谢，说道 ：“感谢 MAC 大佬，我知道我下一步要去哪了！我现在有很多头部兄弟，相信我可以到达最终的目的地！”。
带着众多头部兄弟的数据包，终于准备要出门了。</p>
</blockquote>
<hr>
<h2 id="出口-——-网卡" tabindex="-1"><a class="header-anchor" href="#出口-——-网卡" aria-hidden="true">#</a> 出口 —— 网卡</h2>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4/网络/数据包.drawio.png" alt="数据包"></p>
<ul>
...
<hr>
<h2 id="送别者-——-交换机" tabindex="-1"><a class="header-anchor" href="#送别者-——-交换机" aria-hidden="true">#</a> 送别者 —— 交换机</h2>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/23.jpg" alt="交换机的 MAC 地址表"></p>
...
<hr>
<h2 id="出境大门-——-路由器" tabindex="-1"><a class="header-anchor" href="#出境大门-——-路由器" aria-hidden="true">#</a> 出境大门 —— 路由器</h2>
<blockquote>
<p>路由器与交换机的区别</p>
</blockquote>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/24.jpg" alt="路由器转发"></p>
...
<hr>
<h2 id="互相扒皮-——-服务器-与-客户端" tabindex="-1"><a class="header-anchor" href="#互相扒皮-——-服务器-与-客户端" aria-hidden="true">#</a> 互相扒皮 —— 服务器 与 客户端</h2>
<p>数据包抵达了服务器，服务器肯定高兴呀，正所谓有朋自远方来，不亦乐乎？</p>
<p>服务器高兴的不得了，于是开始扒数据包的皮！就好像你收到快递，能不兴奋吗？</p>
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/键入网址过程/25.jpg" alt="网络分层模型"></p>
...
<hr>
<h2 id="一个数据包臭不要脸的感受" tabindex="-1"><a class="header-anchor" href="#一个数据包臭不要脸的感受" aria-hidden="true">#</a> 一个数据包臭不要脸的感受</h2>
<blockquote>
