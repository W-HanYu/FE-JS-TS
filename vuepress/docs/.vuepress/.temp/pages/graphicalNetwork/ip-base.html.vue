<template><div><h1 id="ip-基础知识全家桶" tabindex="-1"><a class="header-anchor" href="#ip-基础知识全家桶" aria-hidden="true">#</a> IP 基础知识全家桶</h1>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/1.jpg" alt="IP 基础知识全家桶"></p>
<blockquote>
<p>为啥要比喻成菜？因为小林是<strong>菜狗</strong>（押韵不？）</p>
</blockquote>
<hr>
<h2 id="前菜-——-ip-基本认识" tabindex="-1"><a class="header-anchor" href="#前菜-——-ip-基本认识" aria-hidden="true">#</a> 前菜 —— IP 基本认识</h2>
<p>IP 在 TCP/IP 参考模型中处于第三层，也就是<strong>网络层</strong>。</p>
<p>网络层的主要作用是：<strong>实现主机与主机之间的通信，也叫点对点（end to end）通信。</strong></p>
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/2.jpg" alt="IP 的作用"></p>
<blockquote>
<p>网络层与数据链路层有什么关系呢？</p>
</blockquote>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/3.jpg" alt="IP 的作用与 MAC 的作用"></p>
...
<hr>
<h2 id="主菜-——-ip-地址的基础知识" tabindex="-1"><a class="header-anchor" href="#主菜-——-ip-地址的基础知识" aria-hidden="true">#</a> 主菜 —— IP 地址的基础知识</h2>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/4.jpg" alt="点分十进制"></p>
<p>那么，IP 地址最大值也就是</p>
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/5.jpg" alt=""></p>
<p>也就说，最大允许 43 亿台计算机连接到网络。</p>
<p>实际上，IP 地址并不是根据主机台数来配置的，而是以网卡。像服务器、路由器等设备都是有 2 个以上的网卡，也就是它们会有 2 个以上的 IP 地址。</p>
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/6.jpg" alt="每块网卡可以分配一个以上的IP地址"></p>
...
<p>因为会根据一种可以更换 IP 地址的技术 <code v-pre>NAT</code>，使得可连接计算机数超过 43 亿台。 <code v-pre>NAT</code> 技术后续会进一步讨论和说明。</p>
<h3 id="ip-地址的分类" tabindex="-1"><a class="header-anchor" href="#ip-地址的分类" aria-hidden="true">#</a> IP 地址的分类</h3>
<p>互联网诞生之初，IP 地址显得很充裕，于是计算机科学家们设计了<strong>分类地址</strong>。</p>
<p>IP 地址分类成了 5 种类型，分别是 A 类、B 类、C 类、D 类、E 类。</p>
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/7.jpg" alt="IP 地址分类"></p>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/8.jpg" alt=""></p>
<blockquote>
<p>A、B、C 分类地址最大主机个数是如何计算的呢？</p>
</blockquote>
<p>最大主机个数，就是要看主机号的位数，如 C 类地址的主机号占 8 位，那么 C 类地址的最大主机个数：</p>
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/9.jpg" alt=""></p>
<p>为什么要减 2 呢？</p>
<p>因为在 IP 地址中，有两个 IP 是特殊的，分别是主机号全为 1 和 全为 0 地址。</p>
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/10.jpg" alt=""></p>
<ul>
...
<p>当主机号全为 1 时，就表示该网络的广播地址。例如把 <code v-pre>172.20.0.0/16</code> 用二进制表示如下：</p>
<p>10101100.00010100.00000000.00000000</p>
<p>将这个地址的<strong>主机部分全部改为 1</strong>，则形成广播地址：</p>
<p>10101100.00010100.<code v-pre>11111111.11111111</code></p>
<p>再将这个地址用十进制表示，则为 <code v-pre>172.20.255.255</code>。</p>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/11.jpg" alt="本地广播与直接广播"></p>
<blockquote>
<p>什么是 D、E 类地址？</p>
</blockquote>
<p>而 D 类和 E 类地址是没有主机号的，所以不可用于主机 IP，D 类常被用于<strong>多播</strong>，E 类是预留的分类，暂时未使用。</p>
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/12.jpg" alt=""></p>
<blockquote>
<p>多播地址用于什么？</p>
</blockquote>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/13.jpg" alt="单播、广播、多播通信"></p>
<p>多播使用的 D 类地址，其前四位是 <code v-pre>1110</code> 就表示是多播地址，而剩下的 28 位是多播的组编号。</p>
...
<p>其余分类判断方式参考如下图：</p>
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/14.jpg" alt="IP 分类判断"></p>
...
<p>这两个缺点，都可以在 <code v-pre>CIDR</code> 无分类地址解决。</p>
<h3 id="无分类地址-cidr" tabindex="-1"><a class="header-anchor" href="#无分类地址-cidr" aria-hidden="true">#</a> 无分类地址 CIDR</h3>
<p>正因为 IP 分类存在许多缺点，所以后面提出了无分类地址的方案，即 <code v-pre>CIDR</code>。</p>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/15.jpg" alt=""></p>
<p>还有另一种划分网络号与主机号形式，那就是<strong>子网掩码</strong>，掩码的意思就是掩盖掉主机号，剩余的就是网络号。</p>
<p><strong>将子网掩码和 IP 地址按位计算 AND，就可得到网络号。</strong></p>
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/16.jpg" alt=""></p>
<blockquote>
<p>为什么要分离网络号和主机号？</p>
</blockquote>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/17.jpg" alt="IP地址的网络号"></p>
<blockquote>
<p>怎么进行子网划分？</p>
</blockquote>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/18.jpg" alt=""></p>
<ul>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/19.jpg" alt=""></p>
<p>由于子网网络地址被划分成 2 位，那么子网地址就有 4 个，分别是 00、01、10、11，具体划分如下图：</p>
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/20.jpg" alt=""></p>
<p>划分后的 4 个子网如下表格：</p>
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/21.jpg" alt=""></p>
<h3 id="公有-ip-地址与私有-ip-地址" tabindex="-1"><a class="header-anchor" href="#公有-ip-地址与私有-ip-地址" aria-hidden="true">#</a> 公有 IP 地址与私有 IP 地址</h3>
<p>在 A、B、C 分类地址，实际上有分公有 IP 地址和私有 IP 地址。</p>
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/22.jpg" alt=""></p>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/23.jpg" alt="公有 IP 地址与私有 IP 地址"></p>
<blockquote>
<p>公有 IP 地址由谁管理呢？</p>
</blockquote>
<p>私有 IP 地址通常是内部的 IT 人员管理，公有 IP 地址是由 <code v-pre>ICANN</code> 组织管理，中文叫「互联网名称与数字地址分配机构」。</p>
<p>IANA 是 ICANN 的其中一个机构，它负责分配互联网 IP 地址，是按洲的方式层层分配。</p>
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/24.jpg" alt=""></p>
<ul>
<li>ARIN 北美地区</li>
...
<h3 id="ip-地址与路由控制" tabindex="-1"><a class="header-anchor" href="#ip-地址与路由控制" aria-hidden="true">#</a> IP 地址与路由控制</h3>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/25.jpg" alt="IP 地址与路由控制"></p>
<ol>
<li>主机 A 要发送一个 IP 包，其源地址是 <code v-pre>10.1.1.30</code> 和目标地址是 <code v-pre>10.1.2.10</code>，由于没有在主机 A 的路由表找到与目标地址 <code v-pre>10.1.2.10</code> 的网络地址，于是包被转发到默认路由（路由器 <code v-pre>1</code> ）</li>
<li>路由器 <code v-pre>1</code> 收到 IP 包后，也在路由器 <code v-pre>1</code> 的路由表匹配与目标地址相同的网络地址记录，发现匹配到了，于是就把 IP 数据包转发到了 <code v-pre>10.1.0.2</code> 这台路由器 <code v-pre>2</code></li>
<li>路由器 <code v-pre>2</code> 收到后，同样对比自身的路由表，发现匹配到了，于是把 IP 包从路由器 <code v-pre>2</code> 的 <code v-pre>10.1.2.1</code> 这个接口出去，最终经过交换机把 IP 数据包转发到了目标主机</li>
</ol>
<blockquote>
<p>环回地址是不会流向网络</p>
</blockquote>
...
<h3 id="ip-分片与重组" tabindex="-1"><a class="header-anchor" href="#ip-分片与重组" aria-hidden="true">#</a> IP 分片与重组</h3>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/26.jpg" alt="分片与重组"></p>
<p>在分片传输中，一旦某个分片丢失，则会造成整个 IP 数据报作废，所以 TCP 引入了 <code v-pre>MSS</code> 也就是在 TCP 层进行分片不由 IP 层分片，那么对于 UDP 我们尽量不要发送一个大于 <code v-pre>MTU</code> 的数据报文。</p>
<h3 id="ipv6-基本认识" tabindex="-1"><a class="header-anchor" href="#ipv6-基本认识" aria-hidden="true">#</a> IPv6 基本认识</h3>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/27.jpg" alt="IPv6 地址表示方法"></p>
<p>如果出现连续的 0 时还可以将这些 0 省略，并用两个冒号 「::」隔开。但是，一个 IP 地址中只允许出现一次两个连续的冒号。</p>
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/28.jpg" alt="Pv6 地址缺省表示方"></p>
<blockquote>
<p>IPv6 地址的结构</p>
</blockquote>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/29.jpg" alt="IPv6地址结构"></p>
<blockquote>
<p>IPv6 单播地址类型</p>
</blockquote>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/30.jpg" alt=" IPv6 中的单播通信"></p>
<h3 id="ipv4-首部与-ipv6-首部" tabindex="-1"><a class="header-anchor" href="#ipv4-首部与-ipv6-首部" aria-hidden="true">#</a> IPv4 首部与 IPv6 首部</h3>
<p>IPv4 首部与 IPv6 首部的差异如下图：</p>
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/31.jpg" alt="IPv4 首部与 IPv6 首部的差异"></p>
...
<li><strong>取消选项字段。</strong> 选项字段不再是标准 IP 首部的一部分了，但它并没有消失，而是可能出现在 IPv6 首部中的「下一个首部」指出的位置上。删除该选项字段使的 IPv6 的首部成为固定长度的 <code v-pre>40</code> 字节。</li>
</ul>
<hr>
<h2 id="点心-——-ip-协议相关技术" tabindex="-1"><a class="header-anchor" href="#点心-——-ip-协议相关技术" aria-hidden="true">#</a> 点心 —— IP 协议相关技术</h2>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/32.jpg" alt="DNS 树状结构"></p>
...
<p>浏览器首先看一下自己的缓存里有没有，如果没有就向操作系统的缓存要，还没有就检查本机域名解析文件 <code v-pre>hosts</code>，如果还是没有，就会 DNS 服务器进行查询，查询的过程如下：</p>
<ol>
<li>客户端首先会发出一个 DNS 请求，问 www.server.com 的 IP 是啥，并发给本地 DNS 服务器（也就是客户端的 TCP/IP 设置中填写的 DNS 服务器地址）。</li>
<li>本地域名服务器收到客户端的请求后，如果缓存里的表格能找到 www.server.com，则它直接返回 IP 地址。如果没有，本地 DNS 会去问它的根域名服务器：“老大， 能告诉我 www.server.com 的 IP 地址吗？” 根域名服务器是最高层次的，它不直接用于域名解析，但能指明一条道路。</li>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/33.jpg" alt="域名解析的工作流程"></p>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/34.jpg" alt="ARP 广播"></p>
<ul>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/35.jpg" alt="RARP"></p>
<h3 id="dhcp" tabindex="-1"><a class="header-anchor" href="#dhcp" aria-hidden="true">#</a> DHCP</h3>
<p>DHCP 在生活中我们是很常见的了，我们的电脑通常都是通过 DHCP 动态获取 IP 地址，大大省去了配 IP 信息繁琐的过程。</p>
<p>接下来，我们来看看我们的电脑是如何通过 4 个步骤的过程，获取到 IP 的。</p>
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/36.jpg" alt="DHCP 工作流程"></p>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/37.jpg" alt=" DHCP 中继代理"></p>
<ul>
<li>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/38.jpg" alt="NAT"></p>
<blockquote>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/39.jpg" alt="NAPT"></p>
...
<h3 id="icmp" tabindex="-1"><a class="header-anchor" href="#icmp" aria-hidden="true">#</a> ICMP</h3>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/40.jpg" alt="ICMP 目标不可达消息"></p>
<p>如上图例子，主机 <code v-pre>A</code> 向主机 <code v-pre>B</code> 发送了数据包，由于某种原因，途中的路由器 <code v-pre>2</code> 未能发现主机 <code v-pre>B</code> 的存在，这时，路由器 <code v-pre>2</code> 就会向主机 <code v-pre>A</code> 发送一个 <code v-pre>ICMP</code> 目标不可达数据包，说明发往主机 <code v-pre>B</code> 的包未能成功。</p>
<p>ICMP 的这种通知消息会使用 <code v-pre>IP</code> 进行发送 。</p>
<p>因此，从路由器 <code v-pre>2</code> 返回的 ICMP 包会按照往常的路由控制先经过路由器 <code v-pre>1</code> 再转发给主机 <code v-pre>A</code> 。收到该 ICMP 包的主机 <code v-pre>A</code> 则分解 ICMP 的首部和数据域以后得知具体发生问题的原因。</p>
<blockquote>
<p>ICMP 类型</p>
</blockquote>
<p>ICMP 大致可以分为两大类：</p>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/41.jpg" alt="常见的 ICMP 类型"></p>
<h3 id="igmp" tabindex="-1"><a class="header-anchor" href="#igmp" aria-hidden="true">#</a> IGMP</h3>
<p>ICMP 跟 IGMP 是一点关系都没有的，就好像周杰与周杰伦的区别，大家不要混淆了。</p>
<p>在前面我们知道了组播地址，也就是 D 类地址，既然是组播，那就说明是只有一组的主机能收到数据包，不在一组的主机不能收到数组包，怎么管理是否是在一组呢？那么，就需要 <code v-pre>IGMP</code> 协议了。</p>
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/42.jpg" alt="组播模型"></p>
...
<p>接下来，以 <code v-pre>IGMPv2</code> 作为例子，说说<strong>常规查询与响应和离开组播组</strong>这两个工作机制。</p>
<p><em>常规查询与响应工作机制</em></p>
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/43.jpg" alt=" IGMP 常规查询与响应工作机制"></p>
<ol>
<li>路由器会周期性发送目的地址为 <code v-pre>224.0.0.1</code>（表示同一网段内所有主机和路由器） <strong>IGMP 常规查询报文</strong>。</li>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/44.jpg" alt=" IGMPv2 离开组播组工作机制 情况1"></p>
<ol>
...
<p><img src="https://cdn.jsdelivr.net/gh/xiaolincoder/ImageHost/计算机网络/IP/45.jpg" alt=" IGMPv2 离开组播组工作机制 情况2"></p>
<ol>
...
<blockquote>
<p>读者问题：“组播不太懂。。。假设一台机器加入组播地址，需要把IP改成组播地址吗？如果离开某个组播地址，需要dhcp重新请求个IP吗？”</p>
</blockquote>
<p>组播地址不是用于机器ip地址的，因为组播地址没有网络号和主机号，所以跟dhcp没关系。组播地址一般是用于udp协议，机器发送UDP组播数据时，目标地址填的是组播地址，那么在组播组内的机器都能收到数据包。</p>
<p>是否加入组播组和离开组播组，是由socket一个接口实现的，主机ip是不用改变的。</p>
<hr>
</div></template>
