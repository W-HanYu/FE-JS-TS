<template><div><h1 id="linux-系统是如何收发网络包的" tabindex="-1"><a class="header-anchor" href="#linux-系统是如何收发网络包的" aria-hidden="true">#</a> Linux 系统是如何收发网络包的？</h1>
<p>这次，就围绕一个问题来说。</p>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost3@main/操作系统/浮点/OSI与TCP.png" alt=""></p>
<p>不过，我们常说的七层和四层负载均衡，是用 OSI 网络模型来描述的，七层对应的是应用层，四层对应的是传输层。</p>
<hr>
<h2 id="linux-网络协议栈" tabindex="-1"><a class="header-anchor" href="#linux-网络协议栈" aria-hidden="true">#</a> Linux 网络协议栈</h2>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost3@main/操作系统/浮点/封装.png" alt=""></p>
<p>其中：</p>
<ul>
...
<p>这些新增的头部和尾部，都有各自的作用，也都是按照特定的协议格式填充，这每一层都增加了各自的协议头，那自然网络包的大小就增大了，但物理链路并不能传输任意大小的数据包，所以在以太网中，规定了最大传输单元（MTU）是 <code v-pre>1500</code> 字节，也就是规定了单次传输的最大 IP 包大小。</p>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost3@main/操作系统/浮点/协议栈.png" alt=""></p>
...
<h2 id="linux-接收网络包的流程" tabindex="-1"><a class="header-anchor" href="#linux-接收网络包的流程" aria-hidden="true">#</a> Linux 接收网络包的流程</h2>
...
<p>所以为了解决频繁中断带来的性能开销，Linux 内核在 2.6 版本中引入了 <strong>NAPI 机制</strong>，它是混合「中断和轮询」的方式来接收网络包，它的核心概念就是<strong>不采用中断的方式读取数据</strong>，而是首先采用中断唤醒数据接收的服务程序，然后 <code v-pre>poll</code> 的方法来轮询数据。</p>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost3@main/操作系统/浮点/收发流程.png" alt=""></p>
<h2 id="linux-发送网络包的流程" tabindex="-1"><a class="header-anchor" href="#linux-发送网络包的流程" aria-hidden="true">#</a> Linux 发送网络包的流程</h2>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/操作系统/多路复用/sk_buff.jpg" alt=""></p>
<p>至此，传输层的工作也就都完成了。</p>
...
<p>参考资料：</p>
<ul>
<li>Linux 网络包发送过程：https://mp.weixin.qq.com/s/wThfD9th9e_-YGHJJ3HXNQ</li>
<li>Linux 网络数据接收流程（TCP）- NAPI：https://wenfh2020.com/2021/12/29/kernel-tcp-receive/</li>
<li>Linux网络-数据包接收过程：https://blog.csdn.net/frank_jb/article/details/115841622</li>
</ul>
</div></template>
