<template><div><h1 id="https-rsa-握手解析" tabindex="-1"><a class="header-anchor" href="#https-rsa-握手解析" aria-hidden="true">#</a> HTTPS RSA 握手解析</h1>
<p>我前面讲，简单给大家介绍了的 HTTPS 握手过程，但是还不够细！</p>
<p>只讲了比较基础的部分，所以这次我们再来深入一下 HTTPS，用<strong>实战抓包</strong>的方式，带大家再来窥探一次 HTTPS。</p>
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https/https提纲.png" alt=""></p>
<p>对于还不知道对称加密和非对称加密的同学，你先复习我以前的这篇文章<a href="https://mp.weixin.qq.com/s/bUy220-ect00N4gnO0697A" target="_blank" rel="noopener noreferrer">「硬核！30 张图解 HTTP 常见的面试题」，<ExternalLinkIcon/></a>本篇文章默认大家已经具备了这些知识。</p>
<hr>
<h2 id="tls-握手过程" tabindex="-1"><a class="header-anchor" href="#tls-握手过程" aria-hidden="true">#</a> TLS 握手过程</h2>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/计算机网络/HTTP/19-HTTPS与HTTP.png" alt=""></p>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https/tls握手.png" alt=""></p>
...
<p>接下来，我们就以最简单的 <code v-pre>RSA</code> 密钥交换算法，来看看它的 TLS 握手过程。</p>
<hr>
<h2 id="rsa-握手过程" tabindex="-1"><a class="header-anchor" href="#rsa-握手过程" aria-hidden="true">#</a> RSA 握手过程</h2>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https/tls四次握手.png" alt=""></p>
<p>对应 Wireshark 的抓包，我也画了一幅图，你可以从下图很清晰地看到该过程：</p>
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https/https_rsa.png" alt=""></p>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https/clienthello.png" alt=""></p>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https/serverhello.png" alt=""></p>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https/certificate.png" alt=""></p>
<p>随后，服务端发了「<strong>Server Hello Done</strong>」消息，目的是告诉客户端，我已经把该给你的东西都给你了，本次打招呼完毕。</p>
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https/serverhellodone.png" alt=""></p>
<h3 id="客户端验证证书" tabindex="-1"><a class="header-anchor" href="#客户端验证证书" aria-hidden="true">#</a> 客户端验证证书</h3>
<p>在这里刹个车，客户端拿到了服务端的数字证书后，要怎么校验该数字证书是真实有效的呢？</p>
<h4 id="数字证书和-ca-机构" tabindex="-1"><a class="header-anchor" href="#数字证书和-ca-机构" aria-hidden="true">#</a> 数字证书和 CA 机构</h4>
...
<h4 id="数字证书签发和验证流程" tabindex="-1"><a class="header-anchor" href="#数字证书签发和验证流程" aria-hidden="true">#</a> 数字证书签发和验证流程</h4>
...
<h4 id="证书链" tabindex="-1"><a class="header-anchor" href="#证书链" aria-hidden="true">#</a> 证书链</h4>
...
<p>客户端验证完证书后，认为可信则继续往下走。</p>
<p>接着，客户端就会生成一个新的<strong>随机数  (<em>pre-master</em>)</strong>，用服务器的 RSA 公钥加密该随机数，通过「<strong>Client Key Exchange</strong>」消息传给服务端。</p>
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https/clietnkeyexchange.png" alt=""></p>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https/cipherspecmessage.png" alt=""></p>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https/encryptd.png" alt=""></p>
...
<hr>
<h2 id="rsa-算法的缺陷" tabindex="-1"><a class="header-anchor" href="#rsa-算法的缺陷" aria-hidden="true">#</a> RSA 算法的缺陷</h2>
...
<p>为了解决这个问题，后面就出现了 ECDHE 密钥协商算法，我们现在大多数网站使用的正是 ECDHE 密钥协商算法，关于 ECDHE 握手的过程，将在下一篇揭晓。</p>
</div></template>
