<template><div><h1 id="为什么-tcp-每次建立连接时-初始化序列号都要不一样呢" tabindex="-1"><a class="header-anchor" href="#为什么-tcp-每次建立连接时-初始化序列号都要不一样呢" aria-hidden="true">#</a> 为什么 TCP 每次建立连接时，初始化序列号都要不一样呢？</h1>
<p>大家好，我是涵宇。</p>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/ed84bb4aa742a33f50d8035da2867ca2.png" alt=""></p>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/1d497c38621ebc44ee3d8763fd03da67.png" alt="图片"></p>
...
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code><span class="token comment">// tcp_paws_check 函数如果返回 true 则 PAWS 通过：</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>要解决时间戳回绕的问题，可以考虑以下解决方案：</p>
