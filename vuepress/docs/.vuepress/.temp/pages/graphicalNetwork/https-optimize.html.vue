<template><div><h1 id="https-如何优化" tabindex="-1"><a class="header-anchor" href="#https-如何优化" aria-hidden="true">#</a> HTTPS 如何优化？</h1>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https优化/优化https提纲.png" alt=""></p>
<hr>
<h2 id="分析性能损耗" tabindex="-1"><a class="header-anchor" href="#分析性能损耗" aria-hidden="true">#</a> 分析性能损耗</h2>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https优化/tls性能损耗.png" alt=""></p>
<hr>
<h2 id="硬件优化" tabindex="-1"><a class="header-anchor" href="#硬件优化" aria-hidden="true">#</a> 硬件优化</h2>
<p>玩游戏时，如果我们怎么都战胜不了对方，那么有一个最有效、最快的方式来变强，那就是「充钱」，如果还是不行，那说明你充的钱还不够多。</p>
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https优化/充钱.jpg" alt=""></p>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https优化/aesni_intel.png" alt=""></p>
<p>如果我们的 CPU 支持 AES-NI 特性，那么对于对称加密的算法应该选择 AES 算法。否则可以选择 ChaCha20 对称加密算法，因为 ChaCha20 算法的运算指令相比 AES 算法会对 CPU 更友好一点。</p>
<hr>
<h2 id="软件优化" tabindex="-1"><a class="header-anchor" href="#软件优化" aria-hidden="true">#</a> 软件优化</h2>
...
<hr>
<h2 id="协议优化" tabindex="-1"><a class="header-anchor" href="#协议优化" aria-hidden="true">#</a> 协议优化</h2>
<p>协议的优化就是对「密钥交换过程」进行优化。</p>
<h3 id="密钥交换算法优化" tabindex="-1"><a class="header-anchor" href="#密钥交换算法优化" aria-hidden="true">#</a> 密钥交换算法优化</h3>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https优化/ssl_ecdh_curve.png" alt=""></p>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https优化/ssl_ciphers.png" alt=""></p>
<h3 id="tls-升级" tabindex="-1"><a class="header-anchor" href="#tls-升级" aria-hidden="true">#</a> TLS 升级</h3>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https优化/tls1.2and1.3.png" alt=""></p>
...
<p>而且，TLS1.3 对密码套件进行“减肥”了，
<strong>对于密钥交换算法，废除了不支持前向安全性的  RSA 和 DH 算法，只支持 ECDHE 算法</strong>。</p>
...
<hr>
<h2 id="证书优化" tabindex="-1"><a class="header-anchor" href="#证书优化" aria-hidden="true">#</a> 证书优化</h2>
...
<h3 id="证书传输优化" tabindex="-1"><a class="header-anchor" href="#证书传输优化" aria-hidden="true">#</a> 证书传输优化</h3>
...
<h3 id="证书验证优化" tabindex="-1"><a class="header-anchor" href="#证书验证优化" aria-hidden="true">#</a> 证书验证优化</h3>
...
<h4 id="crl" tabindex="-1"><a class="header-anchor" href="#crl" aria-hidden="true">#</a> CRL</h4>
<p>CRL 称为证书吊销列表（<em>Certificate Revocation List</em>），这个列表是由 CA 定期更新，列表内容都是被撤销信任的证书序号，如果服务器的证书在此列表，就认为证书已经失效，不在的话，则认为证书是有效的。</p>
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https优化/crl.png" alt=""></p>
<p>但是 CRL 存在两个问题：</p>
<ul>
...
<h4 id="ocsp" tabindex="-1"><a class="header-anchor" href="#ocsp" aria-hidden="true">#</a> OCSP</h4>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https优化/ocsp.png" alt=""></p>
...
<h4 id="ocsp-stapling" tabindex="-1"><a class="header-anchor" href="#ocsp-stapling" aria-hidden="true">#</a> OCSP Stapling</h4>
<p>于是为了解决这一个网络开销，就出现了 OCSP Stapling，其原理是：服务器向 CA 周期性地查询证书状态，获得一个带有时间戳和签名的响应结果并缓存它。</p>
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https优化/opscp-stapling.png" alt=""></p>
<p>当有客户端发起连接请求时，服务器会把这个「响应结果」在 TLS 握手过程中发给客户端。由于有签名的存在，服务器无法篡改，因此客户端就能得知证书是否已被吊销了，这样客户端就不需要再去查询。</p>
<hr>
<h2 id="会话复用" tabindex="-1"><a class="header-anchor" href="#会话复用" aria-hidden="true">#</a> 会话复用</h2>
...
<h3 id="session-id" tabindex="-1"><a class="header-anchor" href="#session-id" aria-hidden="true">#</a> Session ID</h3>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https优化/sessionid.png" alt=""></p>
<p>但是它有两个缺点：</p>
<ul>
...
<h3 id="session-ticket" tabindex="-1"><a class="header-anchor" href="#session-ticket" aria-hidden="true">#</a> Session Ticket</h3>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https优化/ticket.png" alt=""></p>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https优化/重放攻击.png" alt=""></p>
...
<h3 id="pre-shared-key" tabindex="-1"><a class="header-anchor" href="#pre-shared-key" aria-hidden="true">#</a> Pre-shared Key</h3>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https优化/0-RTT.png" alt=""></p>
<p>同样的，Pre-shared Key 也有重放攻击的危险。</p>
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/https优化/0-rtt-attack.png" alt=""></p>
...
<p>参考资料：</p>
<ol>
<li>http://www.doc88.com/p-8621583210895.html</li>
<li>https://zhuanlan.zhihu.com/p/33685085</li>
<li>https://en.wikipedia.org/wiki/Replay_attack</li>
<li>https://en.wikipedia.org/wiki/Downgrade_attack</li>
<li>https://www.cnblogs.com/racent-Z/p/14011056.html</li>
<li>http://www.guoyanbin.com/a-detailed-look-at-rfc-8446-a-k-a-tls-1-3/</li>
<li>https://www.thesslstore.com/blog/crl-explained-what-is-a-certificate-revocation-list/</li>
</ol>
<hr>
</div></template>
