<template><div><h1 id="http-3-强势来袭" tabindex="-1"><a class="header-anchor" href="#http-3-强势来袭" aria-hidden="true">#</a> HTTP/3 强势来袭</h1>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/http3/HTTP3提纲.png" alt=""></p>
<h2 id="美中不足的-http-2" tabindex="-1"><a class="header-anchor" href="#美中不足的-http-2" aria-hidden="true">#</a> 美中不足的 HTTP/2</h2>
...
<p>比如下图中，Stream 2 有一个 TCP 报文丢失了，那么即使收到了 Stream 3 和 Stream 4 的 TCP 报文，应用层也是无法读取的，相当于阻塞了 Stream 3 和 Stream 4 请求。</p>
...
<p>举个例子，如下图：</p>
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/http3/tcp队头阻塞.gif" alt=""></p>
...
<h3 id="tcp-与-tls-的握手时延迟" tabindex="-1"><a class="header-anchor" href="#tcp-与-tls-的握手时延迟" aria-hidden="true">#</a> TCP 与 TLS 的握手时延迟</h3>
<p>发起 HTTP 请求时，需要经过 TCP 三次握手和 TLS 四次握手（TLS 1.2）的过程，因此共需要 3 个 RTT 的时延才能发出请求数据。</p>
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/http3/TCP%2BTLS.gif" alt=""></p>
<p>另外，TCP 由于具有「拥塞控制」的特性，所以刚建立连接的 TCP 会有个「慢启动」的过程，它会对 TCP 连接产生“减速”效果。</p>
<h3 id="网络迁移需要重新连接" tabindex="-1"><a class="header-anchor" href="#网络迁移需要重新连接" aria-hidden="true">#</a> 网络迁移需要重新连接</h3>
...
<h2 id="quic-协议的特点" tabindex="-1"><a class="header-anchor" href="#quic-协议的特点" aria-hidden="true">#</a> QUIC 协议的特点</h2>
...
<h3 id="无队头阻塞" tabindex="-1"><a class="header-anchor" href="#无队头阻塞" aria-hidden="true">#</a> 无队头阻塞</h3>
...
<h3 id="更快的连接建立" tabindex="-1"><a class="header-anchor" href="#更快的连接建立" aria-hidden="true">#</a> 更快的连接建立</h3>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/http3/0-rtt.gif" alt=""></p>
...
<h2 id="http-3-协议" tabindex="-1"><a class="header-anchor" href="#http-3-协议" aria-hidden="true">#</a> HTTP/3 协议</h2>
...
<p><img src="https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/网络/http3/http3frame.png" alt=""></p>
...
<p>参考资料：</p>
<ol>
<li>https://medium.com/faun/http-2-spdy-and-http-3-quic-bae7d9a3d484</li>
...
<li>https://tools.ietf.org/html/draft-ietf-quic-http-34</li>
<li>https://tools.ietf.org/html/draft-ietf-quic-transport-34#section-17</li>
<li>https://ably.com/topic/http3?amp%3Butm_campaign=evergreen&amp;amp%3Butm_source=reddit&amp;utm_medium=referral</li>
<li>https://www.nginx.org.cn/article/detail/422</li>
<li>https://www.bilibili.com/read/cv793000/</li>
<li>https://www.chinaz.com/2020/1009/1192436.shtml</li>
</ol>
<hr>
</div></template>
