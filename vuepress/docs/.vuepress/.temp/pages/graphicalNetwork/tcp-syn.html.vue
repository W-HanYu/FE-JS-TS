<template><div><h1 id="syn-报文什么时候情况下会被丢弃" tabindex="-1"><a class="header-anchor" href="#syn-报文什么时候情况下会被丢弃" aria-hidden="true">#</a> SYN 报文什么时候情况下会被丢弃？</h1>
<p>首先抛出来一个问题：</p>
<blockquote>
<p>syn 包什么时候会被丢弃？</p>
</blockquote>
...
<ul>
<li>
<p>开启 tcp_tw_recycle 参数，并且在 NAT 环境下，造成 SYN 报文被丢弃</p>
</li>
<li>
<p>TCP 两个队列满了（半连接队列和全连接队列），造成 SYN 报文被丢弃</p>
</li>
</ul>
<h2 id="坑爹的-tcp-tw-recycle" tabindex="-1"><a class="header-anchor" href="#坑爹的-tcp-tw-recycle" aria-hidden="true">#</a> 坑爹的 tcp_tw_recycle</h2>
<p>TCP 四次挥手过程中，主动断开连接方会有一个 TIME_WAIT 的状态，这个状态会持续 2 MSL 后才会转变为 CLOSED 状态。</p>
<p><img src="https://img-blog.csdnimg.cn/img_convert/bee0c8e8d84047e7434803fb340f9e5d.png" alt=""></p>
<p>在 Linux  操作系统下，TIME_WAIT 状态的持续时间是 60 秒，这意味着这 60 秒内，客户端一直会占用着这个端口。要知道，端口资源也是有限的，一般可以开启的端口为 32768~61000 ，也可以通过如下参数设置指定范围：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code> net.ipv4.ip_local_port_range
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>如果客户端（发起连接方）的 TIME_WAIT 状态过多</strong>，占满了所有端口资源，那么就无法对「目的 IP+ 目的 PORT」都一样的服务器发起连接了，但是被使用的端口，还是可以继续对另外一个服务器发起连接的。具体可以看我这篇文章：<a href="https://xiaolincoding.com/network/3_tcp/port.html#%E5%AE%A2%E6%88%B7%E7%AB%AF%E7%9A%84%E7%AB%AF%E5%8F%A3%E5%8F%AF%E4%BB%A5%E9%87%8D%E5%A4%8D%E4%BD%BF%E7%94%A8%E5%90%97" target="_blank" rel="noopener noreferrer">客户端的端口可以重复使用吗？<ExternalLinkIcon/></a></p>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/f5fbe947240026cc2f076267cb698496.png" alt=""></p>
...
<h2 id="accpet-队列满了" tabindex="-1"><a class="header-anchor" href="#accpet-队列满了" aria-hidden="true">#</a> accpet 队列满了</h2>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/c9959166180b0e239bb48234ff7c2f5b.png" alt=""></p>
<h3 id="半连接队列满了" tabindex="-1"><a class="header-anchor" href="#半连接队列满了" aria-hidden="true">#</a> 半连接队列满了</h3>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/58e01036d1febd0103dd0ec4d5acff05.png" alt=""></p>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/e795b4ff5be76c85814ee190b4921f25.png" alt=""></p>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/29f1fd2894162e15cbac938a2373b543.png" alt=""></p>
<p>增大 backlog 的方式，每个 Web 服务都不同，比如 Nginx 增大 backlog 的方法如下：</p>
<p><img src="https://img-blog.csdnimg.cn/img_convert/a6b11fbd1fcb742cdcc87447fc23b73f.png" alt=""></p>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/54b7411607978cb9ff36d88cf47eb5c4.png" alt=""></p>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/19443a03430368b72c201113150471c5.png" alt=""></p>
<h3 id="全连接队列满了" tabindex="-1"><a class="header-anchor" href="#全连接队列满了" aria-hidden="true">#</a> 全连接队列满了</h3>
<p><strong>在服务端并发处理大量请求时，如果 TCP accpet 队列过小，或者应用程序调用 accept() 不及时，就会造成 accpet 队列满了 ，这时后续的连接就会被丢弃，这样就会出现服务端请求数量上不去的现象。</strong></p>
<p><img src="https://img-blog.csdnimg.cn/img_convert/d1538f8d3b50da26039bc6b171a13ad1.png" alt=""></p>
<p>我们可以通过 ss 命令来看 accpet 队列大小，在「LISTEN 状态」时，<code v-pre>Recv-Q/Send-Q</code> 表示的含义如下：</p>
<p><img src="https://img-blog.csdnimg.cn/img_convert/d7e8fcbb4afa583687b76064b7f1afac.png" alt=""></p>
<ul>
<li>Recv-Q：当前 accpet 队列的大小，也就是当前已完成三次握手并等待服务端 <code v-pre>accept()</code> 的 TCP 连接个数；</li>
...
<p>关于 SYN 队列和 accpet 队列，我之前写过一篇很详细的文章：<a href="https://mp.weixin.qq.com/s/2qN0ulyBtO2I67NB_RnJbg" target="_blank" rel="noopener noreferrer">TCP 半连接队列和全连接队列满了会发生什么？又该如何应对？<ExternalLinkIcon/></a></p>
<hr>
</div></template>
