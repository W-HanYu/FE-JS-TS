...
::: tip
TypeScript 提供最新的和不断发展的 JavaScript 特性，包括那些来自 2015 年的 ECMAScript 和未来的提案中的特性，比如异步功能和 Decorators，以帮助建立健壮的组件。下图显示了 TypeScript 与 ES2022、ES2016+、ES2016 、ES205和 ES5 之间的关系：
:::
<!-- ![1](../assets/0.0.jpeg) -->
<img src="../assets/0.0.png" width="400px">
